...
INSERT INTO winyourlife.users_info (created_date, last_modified_date, version, uuid, email, name, streak, longest_streak, completed_tasks, avatar, is_friend_notification_active, is_daily_reminder_active) VALUES
    (NOW(), NOW(), 0, uuid_generate_v4(), 'user1@example.com', 'User One', 5, 10, 50, E'\\x', TRUE, TRUE),
    (NOW(), NOW(), 0, uuid_generate_v4(), 'user2@example.com', 'User Two', 3, 5, 30, E'\\x', FALSE, TRUE),
    (NOW(), NOW(), 0, uuid_generate_v4(), 'user3@example.com', 'User Three', 7, 12, 70, E'\\x', TRUE, FALSE),
    (NOW(), NOW(), 0, uuid_generate_v4(), 'user4@example.com', 'User Four', 2, 4, 15, E'\\x', FALSE, FALSE),
    (NOW(), NOW(), 0, uuid_generate_v4(), 'user5@example.com', 'User Five', 6, 9, 60, E'\\x', TRUE, TRUE);
